...
. Additionally - the Operations team has to perform the following steps in order configure the CLI microservice that the CLI code calls. To do this, follow the steps outlined in the following documentation: 
