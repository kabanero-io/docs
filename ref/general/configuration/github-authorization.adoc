...
e.g. for `organization:` the value may be: https://api.github.com (for public) or https://github.ibm.com/api/v3 (for GHE)

( It is best to consult your security provider to determine the proper authentication endpoint value for `organization:` )
