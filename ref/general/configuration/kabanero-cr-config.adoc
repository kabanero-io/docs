...
** `version` - The release of Kabanero that you want to install.
   ...
   release follows semver notation (for example, 0.8.0).
...
***** `url` - The URL pointing to the stack repository. The URL will
      ...
      default stack repository for Kabanero version 0.8.0 is
      https://github.com/kabanero-io/collections/releases/download/v0.8.0/kabanero-index.yaml
***** `skipCertVerification` - Controls whether the controller will
...
This example yaml defines an instance at version 0.8.0, using
the default stacks.
