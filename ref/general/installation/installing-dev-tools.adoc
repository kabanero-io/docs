...
To get started with application stacks in VS Code, read the guide link:../../../../guides/guide-codewind/[Getting Started with Codewind and Kabanero].
...
To get started with application stacks in your Eclipse IDE, read the guide link:../../../../guides/guide-codewind/[Getting Started with Codewind and Kabanero].
