...
. Select the service account that is used by the pipeline you want to trigger. You can either specify `pipelines` or your own custom service account. For more information, see <<#serviceaccount, Service account>>.
